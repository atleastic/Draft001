...
public class HomePageActivity extends AppCompatActivity
    ...
    private void setColor() {
        Bitmap bitmap= ((BitmapDrawable)mImageparallax.getDrawable()).getBitmap();
        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener(){

            @Override
            public void onGenerated(Palette palette) {
                mToolbar.setBackgroundColor(palette.getDarkMutedSwatch().getRgb());
                mFrameParallax.setBackgroundColor(palette.getDarkMutedSwatch().getRgb());
            }
        });
    }
